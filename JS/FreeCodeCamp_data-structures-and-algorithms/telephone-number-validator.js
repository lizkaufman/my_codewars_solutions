...
function telephoneCheck(str) {
  if (/[a-zA-Z]/.test(str) || str.length > 17 || str.length < 10) {
    return false;
  }
  ...
  const validFormats = [
    ...
    /^1\s{1}\d{3}-\d{3}-\d{4}$/, //1 555-555-5555
    /^\(\d{3}\)\d{3}-\d{4}$/, //(555)555-5555
    /^\(\d{3}\)\s{1}\d{3}-\d{4}$/, //(555) 555-5555
    /^1\s\(\d{3}\)\s\d{3}-\d{4}$/, //1 (555) 555-5555
    /^1\(\d{3}\)\s{1}\d{3}-\d{4}$/, //1(555) 555-5555
    /^1\(\d{3}\)\d{3}-\d{4}$/, //1(555)555-5555
    /^\d{3}\s{1}\d{3}\s{1}\d{4}$/, //555 555 5555
    /^1\s{1}\d{3}\s{1}\d{3}\s{1}\d{4}$/, //1 555 555 5555
  ];
